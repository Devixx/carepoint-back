...
const appointments_list_query_dto_1 = require("./dto/appointments-list.query.dto");
let AppointmentsController = class AppointmentsController {
    ...
    findAll(req, query) {
        return this.appointmentsService.findAllByDoctor(req.user.id, query);
    }
    getCalendarData(date, req) {
    ...
    async list(req, query) {
        ...
        return this.appointmentsService.listByDoctor(doctorId, {
            page: query.page,
            limit: query.limit,
            sort: query.sort,
            order: query.order,
...
__decorate([
    (0, common_1.Get)("calendar/:date"),
    __param(0, (0, common_1.Param)("date")),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], AppointmentsController.prototype, "getCalendarData", null);
__decorate([
    (0, common_1.Get)(":id"),
...
__decorate([
    ...
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, appointments_list_query_dto_1.AppointmentsListQueryDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AppointmentsController.prototype, "day", null);
